...
module CHEM_DRV
  ...
  REAL(fp), PARAMETER ::  AP(41) = (/ &
       0.000000e+00, 2.033680e-03, 4.263840e-03, 6.808400e-03, &
       9.549440e-03, 1.260488e-02, 1.616136e-02, 2.022872e-02, &
       2.480696e-02, 2.970944e-02, 3.487728e-02, 4.041888e-02, &
       4.715096e-02, 5.759304e-02, 8.107344e-02, 1.438356e-01, &
       3.134213e-01, 7.262622e-01, 1.618105e+00, 3.386614e+00, &
       6.521732e+00, 1.167622e+01, 1.918871e+01, 2.906671e+01, &
       3.974347e+01, 4.790509e+01, 5.194789e+01, 5.301237e+01, &
       4.917287e+01, 4.076298e+01, 3.054420e+01, 1.994800e+01, &
       9.997717e+00, 5.619734e+00, 3.159951e+00, 1.779990e+00, &
       1.000000e+00, 5.620000e-01, 3.160000e-01, 1.780000e-01, &
       1.000000e-01 /) 

  ! Bp [unitless] for 40 levels (41 edges)]
  REAL(fp), PARAMETER ::  BP(41) = (/ &
       1.000000e+00, 9.796727e-01, 9.573127e-01, 9.319036e-01, &
       9.044618e-01, 8.739709e-01, 8.383982e-01, 7.977437e-01, &
       7.520073e-01, 7.032218e-01, 6.524036e-01, 6.005687e-01, &
       5.477163e-01, 4.968927e-01, 4.480883e-01, 4.022929e-01, &
       3.594376e-01, 3.204001e-01, 2.849409e-01, 2.516396e-01, &
       2.199982e-01, 1.883372e-01, 1.563123e-01, 1.228997e-01, &
       8.969160e-02, 6.107206e-02, 3.867084e-02, 2.031263e-02, &
       7.954400e-03, 2.273390e-03, 4.632100e-04, 5.285000e-05, &
       2.320000e-06, 2.700000e-07, 5.000000e-08, 1.000000e-08, &
